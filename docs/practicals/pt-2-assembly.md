...
!!! Task
      ...
      [Part 1: Read cleaning](pt-1-read-cleaning.md), create a new main directory for today's practical (e.g., `2026-09-24-assembly`), the `input`, `tmp`, and `results` subdirectories, and the file `WHATIDID.txt` to log your commands. 

      To help get you started 
      ```
      mkdir 2026-09-24-assembly
      ```
...
!!! Task 
      ...
      ```
      cd ~/2026-09-24-assembly/results
